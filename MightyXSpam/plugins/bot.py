...
MIG_PIC = ALIVE_PIC if ALIVE_PIC else "https://telegra.ph/file/ed70e0c936bdd1b779702.jpg"

MIG_TEXT = ALIVE_TEXT if ALIVE_TEXT else "╚»★ 𝗜𝗻𝗳𝗶𝗻𝘁𝗲𝗦𝗼𝘂𝗟𝗫𝗦𝗽𝗮𝗺 𝗶𝘀 𝗛𝗲𝗿𝗲 ★«╝"
...
async def alive(event):
  if event.sender_id in SUDO_USERS:
      ...
      await event.client.send_file(event.chat_id,
                                  MIG_PIC, caption=f"""{MIG_TEXT}\n\n═══════════════════\n⚡ 𝐏𝐢𝐧𝐠  : `{ms}ᵐˢ`\n⚡ 𝐎𝐰𝐧𝐞𝐫 : {mention}\n⚡ 𝐈𝐧𝐟𝐢𝐧𝐭𝐞𝐒𝐨𝐮𝐋 𝐗 𝐒𝐩𝐚𝐦 : `{mightyversion}`\n⚡ 𝐏𝐲𝐭𝐡𝐨𝐧 𝐕𝐞𝐫𝐬𝐢𝐨𝐧 : `3.9.6`\n⚡ 𝐓𝐞𝐥𝐞𝐭𝐡𝐨𝐧 𝐕𝐞𝐫𝐬𝐢𝐨𝐧 : `{version.__version__}`\n═══════════════════\n\n""", buttons=[
        [
        Button.url("✨ ᴄʜᴀɴɴᴇʟ ✨", "https://t.me/TheNavya"),
        Button.url("✨ sᴜᴘᴘᴏʀᴛ ✨", "https://t.me/NavyASupport")
        ],
        [
        Button.url("🔥 ʀᴇᴘᴏ 🔥", "https://github.com/t.me/TheNavya/")
        ]
        ]
        )
...
async def restart(e):
    if e.sender_id in SUDO_USERS:
        text = "𝗥𝗲𝘀𝘁𝗮𝗿𝘁𝗶𝗻𝗴 𝗬𝗼𝘂𝗿 𝗜𝗻𝗳𝗶𝗻𝘁𝗲𝗦𝗼𝘂𝗟 𝗫 𝗦𝗽𝗮𝗺... | Please Wait For Few Seconds."
