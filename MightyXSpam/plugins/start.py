...
MIG_IMG = ALIVE_PIC if ALIVE_PIC else "https://telegra.ph/file/d2a5ca6be8d8b57a48f7b.jpg"

Mig_Button = [
        [
        Button.url("✨ sᴜᴘᴘᴏʀᴛ ✨", "https://t.me/TheNavya")
        ],
        [
...
MigX_Button = [
        ...
        [
        Button.url("🔥 ʀᴇᴘᴏ 🔥", "https://t.me//TheNavya/")
        ]
        ]
